...
\documentclass[
    ...
    ColaboratorName = 刘英,
    % Title
    Title           = 基于正例和无标注数据的分布式学习,
    TitleEng        = 
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于正例和无标注数据}{的分布式学习研究}
% \titleengtwolines{English Title Line One}{Englisht Title Line Two}
\titleengtwolines{Distributed Learning Research}{Based on Positive and Unlabeled Data}
